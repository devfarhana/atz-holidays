        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{route('package-tour.create')}}" class="btn btn-sm fw-bold btn-primary">Create
                        Package</a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('package-tour.toggle-hotDeals', $package->id) }}" class="badge badge-danger">Hot Deal</a>
                                    @else
                                        <a href="{{ route('package-tour.toggle-hotDeals', $package->id) }}" class="badge badge-info">None</a>
                                    @endif

                                    </td>
                                    <td>
                                        @if($package->status)
                                        <a href="{{ route('package-tour.toggle-status', $package->id) }}"
                                    ...
                                    <td>
                                        <a href="{{route('package-tour.info', $package->id)}}"
                                        ...
                                        @include('admin.tour-package.package-tour.images-modal')
                                        @include('admin.tour-package.package-tour.feature-modal')
                                    </td>
                                    <td>
                                        <a href="{{ route('package-tour.edit',$package->id) }}"
                                        ...
                                        <form id="delete-package-form-{{ $package->id }}"
                                            action="{{ route('package-tour.destroy', $package->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
