    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <!-- Update Form -->
                <form action="{{ route('images.store', $package->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method("POST")

                    <div class="row p-5">
                        <input type="text" name="package_tour_id" id="" value="{{ $package->id }}" style="display: none">
