            ...
            <div class="col-lg-9">
                <div class="tab-content" id="v-pills-without-border-tabContent">
                                                ...
                                                <table class="display table table-striped table-hover basic-datatables"
                                                    ...
                                                    <tbody>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            @include('admin.tour-package.package-tour.package-info.overview')
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'video' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.video.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                    <h3>Package Video</h3>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <td>
                                                            @if($video->status)
                                                            <a href="{{ route('video.toggle', $video->id) }}"
                                                    ...
                                                    <form id="delete-package-form-{{ $video->id }}"
                                                        ...
                                                        @include('admin.tour-package.package-tour.package-info.video.edit-modal')
                                                    </td>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'activities' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.activity.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($activity->status)
                                                        <a href="{{ route('activity.toggle', $activity->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('activity.toggle', $activity->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        @include('admin.tour-package.package-tour.package-info.activity.edit-modal')
                                                    </td>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'hotel' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.hotel.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                    <h3>Package Hotel</h3>
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($hotel->status)
                                                        <a href="{{ route('packagehotel.toggle', $hotel->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('packagehotel.toggle', $hotel->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete-package-form-{{ $hotel->id }}"
                                                            action="{{ route('packagehotel.destroy', $hotel->id) }}"
                                                            method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        @include('admin.tour-package.package-tour.package-info.hotel.edit-modal')
                                                    </td>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'itinerary' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.itinerary.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($itinerary->status)
                                                        <a href="{{ route('itinerary.toggle', $itinerary->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('itinerary.toggle', $itinerary->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        @include('admin.tour-package.package-tour.package-info.itinerary.edit-modal')
                                                    </td>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'inclusions' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.inclusion.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($inclusion->status)
                                                        <a href="{{ route('inclusion.toggle', $inclusion->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('inclusion.toggle', $inclusion->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete-package-form-{{ $inclusion->id }}"
                                                            action="{{ route('inclusion.destroy', $inclusion->id) }}"
                                                            method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        @include('admin.tour-package.package-tour.package-info.inclusion.edit-modal')
                                                    </td>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'exclusions' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.exclusion.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($exclusion->status)
                                                        <a href="{{ route('exclusion.toggle', $exclusion->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('exclusion.toggle', $exclusion->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete-package-form-{{ $exclusion->id }}"
                                                            action="{{ route('exclusion.destroy', $exclusion->id) }}"
                                                            method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        @include('admin.tour-package.package-tour.package-info.exclusion.edit-modal')
                                                    </td>
                                                ...
                                                <table class="display table table-striped table-hover basic-datatables"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="text-center">
                                                                <form
                                                                    action="{{ route('price .toggle', $project_status->id) }}"
                                                            ...
                                                            <td class="text-center">
                                                                <div class="form-button-action">
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        action="{{ route('price .destroy', $project_status->id) }}"
                                                                        method="POST" style="display: none;">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
                    ...
                    <div class="tab-pane fade {{ session('activeTab') == 'policy' ? 'show active' : '' }}"
                        ...
                        @include('admin.tour-package.package-tour.package-info.policy.create-modal')
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                        ...
                                        <table class="table table-row-bordered gy-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($policy->status)
                                                        <a href="{{ route('policy.toggle', $policy->id) }}"
                                                            class="badge badge-success">Active</a>
                                                        @else
                                                        <a href="{{ route('policy.toggle', $policy->id) }}"
                                                            class="badge badge-danger">Inactive</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete-package-form-{{ $policy->id }}"
                                                            action="{{ route('policy.destroy', $policy->id) }}"
                                                            method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        @include('admin.tour-package.package-tour.package-info.policy.edit-modal')
                                                    </td>
