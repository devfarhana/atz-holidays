...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Dashboard
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="index.html" class="text-muted text-hover-primary"> Hajj & Umrah Package </a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <h3>Package Edit Form</h3>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row p-5">
                            <form action="{{ route('hajj-package.update', $package->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class=" col-md-12 mb-7">
                                        ...
                                        <div class=" col-md-12 mb-7">
                                            ...
                                            <input type="text" name="location"  class="form-control" value="{{$package->location}}" placeholder="Enter Location" />
                                            @error('location') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>

                                            <div class=" col-md-6 mb-7">
                                                <label class="form-label" for="floatingInput">Country</label>
                                                <input type="text" name="country"  class="form-control" value="{{$package->country}}" placeholder="Enter Country" />
                                                @error('country') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                    <div class=" col-md-6 mb-7">
                                        <label class="form-label" for="floatingInput">Duration</label>
                                        <input type="text" name="duration"  class="form-control" value="{{$package->duration}}" placeholder="Enter Duration" />
                                        @error('duration') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class=" col-md-6 mb-7">
                                        <label class="form-label" for="floatingInput">Package Price</label>
                                        <input type="text" name="price"  class="form-control" value="{{$package->price}}" placeholder="Enter Package Price" />
                                        @error('price') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class=" col-md-6 mb-7">
                                        <label class="form-label" for="floatingInput">Package Offer</label>
                                        <input type="text" name="offer"  class="form-control" value="{{$package->offer}}" placeholder="Enter Package Offer" />
                                        @error('offer') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class=" col-md-6 mb-7">
                                        <label class="form-label" for="floatingInput">Holiday Theme</label>
                                        <input type="text" name="holiday_theme"  class="form-control" value="{{$package->holiday_theme}}" placeholder="Enter Holiday Theme" />
                                    ...
                                    <div class="col-md-12 mb-7">
                                        ...
                                        <textarea class="form-control" name="map_url" cols="30" rows="10">{{ $package->map_url }}</textarea>
...
<script>
    function deleteImage(button) {
        ...
        fetch(`/dashboard/package/delete-image/${imageId}`, {
                method: 'DELETE',
                headers: {
