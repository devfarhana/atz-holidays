        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="#" class="text-muted text-hover-primary">Career</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Manage Career</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="card-title">
                 ...
                 <div class="d-flex justify-content-end">
                    <a href="{{route('career.create')}}" class="btn btn-sm fw-bold btn-primary" >Create Career</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('career.edit',$career->id) }}" class="btn btn-sm btn-light-primary m-2">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                         <a href="#" class="btn btn-sm btn-light-danger m-2" id="delete-career-link" data-career-id="{{ $career->id }}">
                                            <i class="fa-solid fa-trash"></i>
                                        </a>

                                        <form id="delete-career-form-{{ $career->id }}" action="{{ route('career.destroy', $career->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
