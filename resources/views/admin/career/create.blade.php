                            ...
                            <form action="{{ route('career.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class=" col-md-12 mb-7">
                                        <label class="form-label" for="floatingInput">Job Title<span class=" text-danger">*</span></label>
                                    ...
                                    <div class=" col-md-6 mb-7">
                                        ...
                                        <input type="text" name="employee_type" class="form-control" placeholder="Enter Employee Type" />
                                    ...
                                    <div class=" col-md-6 mb-7">
                                        ...
                                        <input type="date" name="posted_date" class="form-control" placeholder="Enter Posted Date" />
