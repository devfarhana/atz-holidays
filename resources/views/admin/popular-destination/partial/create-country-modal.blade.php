<div class="modal fade" id="kt_modal_create_country" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <form action="{{ route('popular-destination.country.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-5">
