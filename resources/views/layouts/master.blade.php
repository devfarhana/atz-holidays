...
<head>
    ...
    <meta name="description"
        content="Backpac kWala - A premium Bootstrap 5 template crafted for travel and tour booking. Tailored for travel agencies and booking platforms, it features flight, hotel, and tour reservations, holiday packages, and an intuitive user experience. Fully responsive, highly customizable, and optimized for fast loading to enhance customer engagement.">
    <meta name="keywords"
        content="travel booking template, tour booking, Bootstrap 5 travel template, Backpac kWala, hotel booking, flights booking, holiday packages, tour agency website, travel agency template, travel HTML template, booking system, responsive travel template, Bootstrap travel website">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@100;200;300;400;500;600;700;800&display=swap"
        rel="stylesheet">
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="d-flex align-items-center flex-wrap">
                        <p class="d-flex align-items-center mb-2 me-5 "><i class='bx bxs-phone bx-flashing me-2'></i><a
                                href="{{ $settings->phone }}">{{ $settings->phone }}</a></p>
                        <p class="d-flex align-items-center mb-2"><i class='bx bx-mail-send bx-flashing me-2'></i><a
                                href="{{ $settings->email }}">{{ $settings->email }}</a></p>
                    </div>
                    <div class="header-btn d-flex align-items-center">
                        <button href="javascript:void(0);" class="login-button"><i class='bx bxs-user-account me-2'></i>
                            Login</button>
                        <span class="login-devider"><i class='bx bx-dots-vertical-rounded bx-flashing'></i></span>
                        <button href="javascript:void(0);" class="signup-button"><i
                                class='bx bx-user-plus bx-flashing me-2'></i> Sign Up</button>
                        ...
                        <div class="offcanvas-detail">
                            <div class="offcanvas-head">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <a href="index.php" class="black-logo-responsive">
                                        <img src=" {{ asset('storage/' . $settings->favicon ) }}" style="height: 50px;"
                                            alt="logo-img">
                                    </a>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="cart-dropdown me-3">
                                            <a href="javascript:void(0);" class="position-relative">
                                                <i class="isax isax-shopping-cart"></i><span
                                                    class="count-icon bg-danger">0</span>
                                            </a>
                                        </div>
                            ...
                            <div class="offcanvas__contact">
                                <div class="mt-4">
                                        ...
                                        <div class="w-100">
                                            <div class="dropdown flag-dropdown mb-2">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    <img src="{{ asset('frontend/assets') }}/img/flags/flag.svg"
                                                        class="me-2" alt="flag">ENG
                                                </a>
                                                <ul class="dropdown-menu p-2">
                                                    <li>
                                                        <a class="dropdown-item rounded d-flex align-items-center"
                                                            href="javascript:void(0);">
                                                            <img src="{{ asset('frontend/assets') }}/img/flags/us.png"
                                                                class="me-2" alt="flag">ENG
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item rounded d-flex align-items-center"
                                                            href="javascript:void(0);">
                                                            <img src="{{ asset('frontend/assets') }}/img/flags/jp.png"
                                                                class="me-2" alt="flag">JPN
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item rounded d-flex align-items-center"
                                                            href="javascript:void(0);">
                                                            <img src="{{ asset('frontend/assets') }}/img/flags/cn.png"
                                                                class="me-2" alt="flag">CHI
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="dropdown">
                                                <a href="javascript:void(0);"
                                                    class="dropdown-toggle bg-white border d-block"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    USD
                                                </a>
                                                <ul class="dropdown-menu p-2">
                                                    <li><a class="dropdown-item rounded"
                                                            href="javascript:void(0);">USD</a></li>
                                                    <li><a class="dropdown-item rounded"
                                                            href="javascript:void(0);">YEN</a></li>
                                                    <li><a class="dropdown-item rounded"
                                    ...
                                    <div class="btn btn-dark w-100 mb-3"><a href="javascript:void(0);"
                                            class="text-white" data-bs-toggle="modal" data-bs-target="#login-modal">Sign
                                            In</a> / <a href="javascript:void(0);" class="text-white"
                                            data-bs-toggle="modal" data-bs-target="#register-modal">Sign Up</a></div>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-about">
                            <span class="d-block mb-2 footer-logo-light">
                                <img src=" {{ asset('storage/' . $settings->system_logo ) }}" style="height: 50px;"
                                    alt="logo">
                            </span>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            <p class="fs-14">{{ $settings->footer_text }} Developed by<a
                                    href="https://qbit-tech.com/">QBit Tech</a></p>
                            <div class="d-flex align-items-center">
