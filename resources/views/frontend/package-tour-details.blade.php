...
<div class="breadcrumb-bar text-center"
    style="background: url('{{ asset('storage/' .$banner->package_banner) }}') no-repeat; background-size: cover; width:100%" >
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="slider-for nav-center" id="large-img">
                                            ...
                                            <div class="service-img">
                                                <img src="{{ asset('storage/' . $packageimage->image) }}"
                                        ...
                                        @if($packagetourimages->isNotEmpty())
                                        <a href="{{ asset('storage/' . $packagetourimages->first()->image) }}"
                                            data-fancybox="gallery" class="btn btn-white btn-xs view-btn">
                                        ...
                                        <div class="slider-nav nav-center" id="small-img">
                                            ...
                                            @if($packageimage->package_tour_id == $package->id)
                                            <div class="service-img">
                                                <div><img src="{{ asset('storage/' . $packageimage->image) }}"
                                                        class="img-fluid" alt="Slider Img"></div>
                                            </div>
                                            @endif
                                            @endforeach
                                        </div>
            ...
            <div class="col-xl-4 theiaStickySidebar">
                <div class="card bg-light-200">
                    ...
                    @if($packagetourimages->isNotEmpty())
                    <img src="{{ asset('storage/' . $packagetourimages->first()->image) }}" class="card-img-top"
                        alt="Tour Image">
                    @endif
                    <div class="card-body">
                        <h5 class="">{{ $package->package_name }}</h5>
                        <p class="custom-text-sm border-bottom mb-3"><i class='bx bxs-map bx-flashing'></i> {{
                            $package->location }}</p>
                        <div>
                                ...
                                <div class="d-flex align-items-center w-50">
                                    <div class="d-flex gap-2">
                                        ...
                                        <span class="icon-circle">
                                            <img src="{{ asset('storage/' . $feature->icon) }}" alt="Plane"
                ...
                <div class="card shadow-none">
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-bottom mb-3">
                            <div class="d-flex align-items-center mb-3">
                                <span class="avatar avatar-lg rounded-circle bg-light  text-gray-6 me-2"><img
                                        src="{{ asset('storage/' . $whyBook->icon) }}" alt="Plane"
