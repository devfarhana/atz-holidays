                        ...
                        <div class="modal-body">
                            <div>
                                ...
                                <div class="text-center mb-4">
                                    <p>Booking on <strong>Rainbow Mountain Valley</strong> has been successful with
                                        Reference Number <span class="text-primary"> #12559845</span></p>
                                </div>
                                <div class="d-flex align-items-center justify-content-center ">
                                    <a href="javascript:void(0);" class="btn btn-light d-flex flex-shrink-0 me-2"
                                        data-bs-dismiss="modal">Contact Provider</a>
                                    <a href="booking-confirmation.html"
                                        class="btn btn-primary d-flex flex-shrink-0">View Booking Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card checkout-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="checkout-details">
                            <form action="{{ route('packageorder.submit',$package->slug) }}" method="POST">
                                @csrf
                                <input type="hidden" name="hajj_packages_id" value="{{ $package->id }}">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center flex-wrap">
                                    <div class="form-check d-flex align-items-center me-3 mb-2">
                                        <input class="form-check-input mt-0" type="radio" name="Radio" id="credit-card"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-4 d-flex">
                                            <div class="card-content flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div>
                                                        <img src="assets/img/icons/visa.svg" alt="image"
                                                            class="img-fluid mb-2">
                                                        <p class="fs-16 fw-medium text-gray-6">**** **** **** 2547</p>
                                                    </div>
                                                    <div class="card-edit-icon">
                                                        <a href="javascript:void(0);" class="rounded-circle"> <span
                                        ...
                                        <div class="col-lg-4 d-flex">
                                            <div class="card-content flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div>
                                                        <img src="assets/img/icons/visa-2.svg" alt="image"
                                                            class="img-fluid mb-2">
                                                        <p class="fs-16 fw-medium text-gray-6">**** **** **** 2547</p>
                                                    </div>
                                                    <div class="card-edit-icon">
                                        ...
                                        <div class="col-lg-4 d-flex">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <a href="javascript:void(0);" id="open-folder"
                ...
                <div class="card shadow-none">
                    ...
                    <div class="card-body pt-3">
                        <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                            ...
                            <div>
                                <h5 class="tour-package-title mb-1"><a href="package-tour-details.php">{{
                                        $package->package_name }}</a></h5>
                                <p class="custom-text-sm"><i class="bx bxs-map"></i>{{ $package->location }}</p>
                            </div>
                        </div>
                        <div class="pt-3">
                            <div class="d-flex">
                            ...
                            <div class="d-flex pb-2">
                                ...
                                <div class="d-flex align-items-center w-50">
                                    <div class="">
                                        <p class="custom-text-sm">5 Days & 4 Nights
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body pt-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <a href="javascript:void(0);"
                                class="custom-button-md bg-primary p-3 w-40 flex-shrink-0">Apply Coupon</a>
                        </div>
                        <div>
                            <div class="coupoun-list mb-3">
                                <p class="text-center">Coupon has been applied successfully <a
                                        href="javascript:void(0);"
                                        class=" ms-2 text-primary text-decoration-underline">Remove</a> </p>
                            </div>
                            <div class="coupoun-list-two">
                                <p class="text-center">Code Invalid <a href="javascript:void(0);"
                                        class=" ms-2 text-primary text-decoration-underline">Close</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card shadow-none">
                    ...
                    <div class="card-footer bg-light pt-2">
                        <div class="d-flex align-items-center justify-content-space-between flex-wrap gap-2">
                            <a href="package-tour-details.php" type="submit"
                                class="btn btn-secondary btn-lg w-40 search-btn ms-0  fs-14 mt-3">Back</a>
                            <a type="submit" class="btn btn-primary btn-lg search-btn ms-0 w-40 fs-14 mt-3"
                                data-bs-toggle="modal" data-bs-target="#booking-success">Confirm</a>
                        </div>
                    </div>
                </div> --}}
            </div>
