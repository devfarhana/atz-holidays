...
$(document).ready(function () {
  ...
  $('.chat-member').click(function () {
      if ($(window).width() < 991) {
          ...
          // Hide other .chat-member elements if chat window is visible
  ...
  // Hide the chat window and show all .chat-member elements if the screen is resized
  // $(window).resize(function () {
  //     if ($(window).width() < 991) {
  //       console.log("Sample IN")
  //         $('.chat-cont-left').show();
  //         $('.chat-member').show(); // Show all .chat-member elements on resize
  //     } else {
  //         $('.chat-cont-left').show(); // Show the chat window on larger screens if needed
  //     }
  // });
});
